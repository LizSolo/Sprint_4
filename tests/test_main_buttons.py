...
class TestMainButtons:
    ...
    def test_header_order_button(self, driver):
        ...
        assert  main_page.get_current_url() == data.Urls.SCOOTER_ORDER
    ...
    def test_logo_yandex(self, driver):
        ...
        assert main_page.get_current_url() == data.Urls.DZEN_URL
    ...
    def test_logo_scooter(self, driver):
        ...
        assert order_page.get_current_url() == data.Urls.SCOOTER
